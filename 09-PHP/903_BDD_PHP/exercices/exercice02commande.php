...
## Objectif
// L'objectif de cet exercice est d'apprendre à se connecter à une base de données,
// à récupérer des données depuis deux tables différentes, à les joindre et à les afficher à l'utilisateur.

## Sujet

// Vous devez créer une application de gestion des commandes qui permet de visualiser et de modifier les informations des commandes et des clients.
